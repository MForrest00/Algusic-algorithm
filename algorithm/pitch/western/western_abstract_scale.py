...
class WesternOctavedAbstractScale(OctavedAbstractScale):
    ...
    def render_name(self, note_name, name=None):
        if name is None:
            name = self.primary_name
        return f"{note_name} {name}"


MajorAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 4, 5, 7, 9, 11], primary_name="Major", alternative_names=["Ionian"]
)
MelodicMinorAbstractScale = WesternOctavedAbstractScale(scale_degrees=[2, 3, 5, 7, 9, 11], primary_name="Melodic Minor")
HarmonicMinorAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 3, 5, 7, 8, 11], primary_name="Harmonic Minor", alternative_names=["Mohammedan"]
)
NaturalMinorAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 3, 5, 7, 8, 10], primary_name="Natural Minor", alternative_names=["Aeolian"]
)
DorianAbstractScale = WesternOctavedAbstractScale(scale_degrees=[2, 3, 5, 7, 9, 10], primary_name="Dorian")
PhrygianAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[1, 3, 5, 7, 8, 10], primary_name="Phrygian", alternative_names=["Neopolitan Minor"]
)
...
DiminishedHalftoneWholetoneAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[1, 3, 4, 6, 7, 9, 10], primary_name="Diminished (Halftone - Wholetone)"
)
DiminishedWholetoneHalftoneAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 3, 5, 6, 8, 9, 11], primary_name="Diminished (Wholetone - Halftone)"
)
WholeToneAbstractScale = WesternOctavedAbstractScale(scale_degrees=[2, 4, 6, 8, 10], primary_name="Whole Tone")
MajorPentatonicAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 4, 7, 9], primary_name="Major Pentatonic", alternative_names=["Mongolian"]
)
...
LeadingWholeToneAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 4, 6, 8, 10, 11], primary_name="Leading Whole Tone"
)
DoubleHarmonicAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[1, 4, 5, 7, 8, 11], primary_name="Double Harmonic", alternative_names=["Byzantine"]
)
OvertoneAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 4, 6, 7, 9, 10], primary_name="Overtone", alternative_names=["Lydian ♭7"]
)
SixToneSymmetricalAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[1, 4, 5, 8, 9], primary_name="Six Tone Symmetrical"
)
AlteredAbstractScale = WesternOctavedAbstractScale(scale_degrees=[1, 3, 4, 6, 8, 10], primary_name="Altered")
AlteredDoubleFlat7AbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[1, 3, 4, 6, 8, 9], primary_name="Altered ♭♭7"
)
...
AugmentedLydianAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 4, 6, 8, 9, 11], primary_name="Augmented Lydian"
)
MixolydianFlatSixAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 4, 5, 7, 8, 10], primary_name="Mixolydian ♭6", alternative_names=["Hindu"]
)
...
AugmentedIonianAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 4, 5, 8, 9, 11], primary_name="Augmented Ionian"
)
DorianSharp4AbstractScale = WesternOctavedAbstractScale(scale_degrees=[2, 3, 6, 7, 9, 10], primary_name="Dorian ♯4")
MajorPhrygianAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[1, 4, 5, 7, 8, 10], primary_name="Major Phrygian"
)
LydianSharp9AbstractScale = WesternOctavedAbstractScale(scale_degrees=[3, 4, 6, 7, 9, 11], primary_name="Lydian ♯9")
DiminishedLydianAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 3, 6, 7, 9, 11], primary_name="Diminished Lydian"
)
...
EightToneSpanishAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[1, 3, 4, 5, 6, 8, 10], primary_name="Eight Tone Spanish"
)
HirajoshiAbstractScale = WesternOctavedAbstractScale(scale_degrees=[2, 3, 7, 8], primary_name="Hirajoshi")
HungarianMajorAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[3, 4, 6, 7, 9, 10], primary_name="Hungarian Major"
)
HungarianMinorAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[2, 3, 6, 7, 8, 11], primary_name="Hungarian Minor", alternative_names=["Gypsy"]
)
...
NeopolitanMajorAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[1, 3, 5, 7, 9, 11], primary_name="Neopolitan Major"
)
...
PrometheusNeopolitanAbstractScale = WesternOctavedAbstractScale(
    scale_degrees=[1, 4, 6, 9, 10], primary_name="Prometheus Neopolitan"
)
